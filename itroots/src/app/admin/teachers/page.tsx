...
const sanitizeFormValues = (values: typeof EMPTY_FORM) => ({
    ...
    assignedCourseId: values.assignedCourseId,
    assignedBatchId: values.assignedBatchId,
});
            ...
            if (selectedFacultyId) {
                ...
                if (formData.assignedCourseId || formData.assignedBatchId) {
                    const assignmentRes = await fetch(ENDPOINTS.ADMIN.Faculty_ASSIGNMENTS(selectedFacultyId), {
                        ...
                        body: JSON.stringify({
                            assignedCourseId: payload.assignedCourseId,
                            assignedBatchId: payload.assignedBatchId,
                        }),
                    });
                        ...
                        <form onSubmit={handleSubmit} className={styles.form}>
                            ...
                            <div className={styles.formGroup}>
                                ...
                                <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                                    ...
                                    <input required value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} placeholder="98765 43210" inputMode="numeric" style={{ flex: 1 }} />
                                </div>
                            </div>
                            <div className={styles.formGroup}>
